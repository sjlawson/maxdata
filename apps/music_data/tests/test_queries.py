...
class MAXQueryTests(TestCase):
    ...
    def test_get_orphan_genres(self):
        ...
        expected = [
            {"export_date": 1625549384231, "id": 27, "name": "J-Pop", "parent_id": 34},
            {"export_date": 1625549384231, "id": 28, "name": "Enka", "parent_id": 34},
            {"export_date": 1625549384231, "id": 29, "name": "Anime", "parent_id": 34},
            {"export_date": 1625549384231, "id": 38, "name": "eBooks", "parent_id": 0},
        ]
